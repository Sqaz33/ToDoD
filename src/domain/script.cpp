...
HandlerScriptDefinition HandlerScriptDefinition::rehydrate(std::string name, std::string source,
                                                           TodoEvent event, bool enabled) {
    return HandlerScriptDefinition(std::move(name), std::move(source), event, enabled);
}

HandlerScriptDefinition::HandlerScriptDefinition(std::string name, std::string source,
                                                 TodoEvent event, bool enabled)
